## The helper functions for data visualization and CSV data extraction 
## This module includes functions to create line charts and extract data from CSV files, which reduce redundancy in the main codebase in Module 1 Code.ipynb
